...
// replaced it for consumer plans), CodeWhale after the subscription CLIs
// because most of its users pay per token rather than monthly, and Ollama
// goes last because it is the odd one out — not a subscription this machine
// spends but a model it owns, reached over HTTP rather than spawned.
export const RUNTIMES = [claudeCode, cursor, codex, gemini, antigravity, codewhale, ollama]
