...
// The Google pair sit together (Gemini CLI and the Antigravity CLI that
// replaced it for consumer plans), Grok Build after them as the fourth
// subscription CLI, CodeWhale after the subscription CLIs because most of its
// users pay per token rather than monthly, and Ollama goes last because it is
// the odd one out — not a subscription this machine spends but a model it
// owns, reached over HTTP rather than spawned.
export const RUNTIMES = [claudeCode, cursor, codex, gemini, antigravity, grok, codewhale, ollama]
