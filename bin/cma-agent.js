...
import {
  ...
  removeProfile, scanProfiles, runtimeModels, runtimeVersions, setDefaultProfile,
...
Logins
  ...
  runtimes:login [--runtime cursor] [--profile work] [--no-start]
...
async function cmdRuntimeLogin(args, fallbackRuntime = null) {
  ...
  await loginProfile(runtime, slug)
